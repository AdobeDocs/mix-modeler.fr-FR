...
| **Données agrégées ou récapitulatives** | Données de haut niveau, détaillant la manière dont un groupe (par exemple, consommateurs, campagnes, régions, etc.) interagit avec votre entreprise ou y joue un rôle |
