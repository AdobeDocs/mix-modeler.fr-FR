...
Pour afficher les insights du modèle, dans la variable ![Modèles](/help/assets//icons/FileData.svg) **[!UICONTROL Models]** dans Mix Modeler :

1. Dans la **[!UICONTROL Models]** , sélectionnez le nom d’un modèle doté d’une **[!UICONTROL Last run status]** de <span style="color:green">●</span> **[!UICONTROL Success]**.

1. Dans le menu contextuel, sélectionnez **[!UICONTROL Model Insights]**.

![Barre d’onglet Informations sur les modèles](/help/assets//model-insights-tabbar.png)

Vous voyez le moment où le modèle spécifié est actualisé pour la dernière fois et les widgets s’affichent à l’aide de quatre onglets : [Informations sur les modèles](#model-insights), [Attribution](#attribution), [Diagnostics](#diagnostics), et [Présentation historique](#historical-overview).
...
* Courbes de réponse marginales.
  <br/>Sélectionnez un canal dans la **[!UICONTROL Channel]** liste déroulante pour mettre à jour le widget d’un canal spécifique.

![Modèle - Informations sur les modèles](/help/assets//model-insights-insights.png)
...
Pour télécharger des données complètes sur les modèles au format Microsoft® Excel, sélectionnez ![Télécharger](/help/assets//icons/Download.svg) **[!UICONTROL Download data]**.

## [!UICONTROL Attribution]

En utilisant la variable [!UICONTROL Attribution] , vous pouvez comprendre l’efficacité des points de contact et des campagnes marketing qui contiennent des données au niveau de l’événement. Les modèles d’attribution suivants sont pris en charge :
...
Voir [Attribution multipoint](../get-started/about.md#multi-touch-attribution) pour une introduction sur la fonctionnalité d’attribution multi-touch en Mix Modeler.

Sélectionnez un ou plusieurs modèles d’attribution dans le **[!UICONTROL Attribution Model]** liste déroulante Les modèles d’attribution sélectionnés s’appliquent à tous les widgets de l’onglet Attribution .
...
La variable [!UICONTROL Overview] Le widget affiche, pour les modèles d’attribution sélectionnés, les totaux et les pourcentages de conversion. La sélection d’autres modèles ajoute des cercles supplémentaires à la visualisation, dont chacun a sa propre couleur correspondant à la légende.
...
La variable [!UICONTROL Daily trends], [!UICONTROL Weekly trends], ou [!UICONTROL Monthly trends] Le widget affiche, pour les modèles d’attribution sélectionnés, les tendances de conversion quotidiennes, hebdomadaires ou mensuelles.

Pour choisir la période, sélectionnez **[!UICONTROL Daily trends]**, **[!UICONTROL Weekly trends]** ou **[!UICONTROL Monthly trends]** de ![Plus](/help/assets//icons/More.svg).
...
La variable [!UICONTROL Breakdown] widget est une ventilation par canal ou point de contact des conversions pour chacun des modèles d’attribution sélectionnés. Ce widget peut s’avérer utile pour prendre des décisions sur l’efficacité de chaque canal ou point de contact.

Pour choisir le type de ventilation, sélectionnez **[!UICONTROL Breakdown by channel]** ou **[!UICONTROL Breakdown by touchpoint]** de ![Plus](/help/assets//icons/More.svg).
...
Pour développer le tableau dans une boîte de dialogue distincte, sélectionnez **[!UICONTROL Expand]** de ![Plus](/help/assets//icons/More.svg).
...
La variable [!UICONTROL Breakdown by touchpoint position] la visualisation est une ventilation des conversions attribuées par position du point de contact et du point de contact sur tous les chemins de conversion. Ce graphique vous permet de comparer si un point de contact contribue mieux à une position qu’à d’autres positions et à d’autres points de contact à n’importe quelle position.
...
La variable [!UICONTROL Top conversion paths] la visualisation affiche les 5 premiers chemins de conversion en fonction des modèles d’attribution sélectionnés.
...
* [!UICONTROL Touchpoint effectiveness] , représentant le résultat du modèle algorithmique Attribution AI. Les données de ce tableau ne sont générées que pour des périodes spécifiques. Sélectionner **[!UICONTROL As of *xx/xx/xx, xx:xx TZ *]**![Infos](/help/assets//icons/InfoOutline.svg) pour plus d’informations.
   ...
   * [!UICONTROL Total volume]: nombre agrégé de fois où un utilisateur touche un point de contact. Le nombre comprend les points de contact qui apparaissent sur un chemin pour effectuer une conversion ainsi que les chemins. *not* ce qui entraîne une conversion.
