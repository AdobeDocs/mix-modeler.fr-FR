...
Vous définissez le nom et la description à l’étape **[!UICONTROL Setup]** :
...
Vous configurez votre modèle à l’étape **[!UICONTROL Configure]**. La configuration implique la définition d’objectifs de conversion, de points de contact marketing, de la population de données éligible, de facteurs externes et internes, etc.
...
Vous pouvez planifier la formation et l’enregistrement de votre modèle à l’étape **[!UICONTROL Schedule]**.

1. Dans la section **[!UICONTROL Schedule]** , vous pouvez planifier la formation et la notation des modèles.

   ![Modèle de planification](../assets/model-schedule.png)

   Pour la notation et la formation de modèle planifiées :
