...
|---|---|---|
| **Téléchargements améliorés** | Vous pouvez désormais [télécharger des informations complètes sur les modèles](../models/insights.md) au format Microsoft® Excel | 31 janvier 2024 |
| **Courbes de réponse marginales** | [Informations sur les modèles](../models/insights.md) fournit un widget supplémentaire pour afficher les courbes de réponse marginales. | 31 janvier 2024 |
