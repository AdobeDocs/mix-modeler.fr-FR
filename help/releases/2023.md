...
| **Attribuer un score à un modèle** | Ajout de la possibilité de déclencher [la notation de nouvelles données à l’aide d’un modèle existant](../models/overview.md#rescore). | 16 Novembre 2023 |
